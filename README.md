...
This monorepo is setup for a dummy `@lecstor/` NPM organization. There are 2 packages by default:

- `@lecstor/react` - A placholder React component
- `@lecstor/utils` - A utils packages

Unlike other TSDX templates, the developer experience for this template is currently a bit more manual.

Your first order of business will be to search and replace `@lecstor` for the npm organization of your own.
